...
<p align="center">
  ...
  I build ML systems that people in the business actually end up using.
</p>

<p align="center">
  <a href="https://achyar.dxight.com">Website</a> ·
...
> A few things from work that I can't open-source: driver-based forecasting adopted across 200 cities for automotive distribution, RAG document assistants with citation-level traceability, and a credit-scoring platform that took report generation from 2 days down to 2 minutes.

---

### Tech I work with

**Data & ML** · Python, SQL, PySpark, scikit-learn, XGBoost, LightGBM, PyTorch, TensorFlow

**GenAI** · LangChain, LangGraph, PydanticAI, HuggingFace, RAG, fine-tuning (LoRA/QLoRA)

**Cloud & MLOps** · GCP (Vertex AI, BigQuery, Looker), Azure, Docker, FastAPI, CI/CD

**Product & BI** · Next.js, Streamlit, Supabase, Power BI
